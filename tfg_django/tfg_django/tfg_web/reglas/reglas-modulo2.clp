...
(defrule mostrar_resolucion_sensible
    ...
    (printout data "En la " ?parte "º parte del compás "?compas " la sensible en la voz " ?voz1 " no resuelve. La sensible es una nota que provoca inestabilidad y que se siente atraída por resolver en la tónica de la tonalidad. Al no estar resuelta, esa inestabilidad se mantiene provocando una falta de coherencia en la línea melódica.." )
    (close data)
)
...
(defrule mostrar_resolucion_septima
    ...
    (open " ./tfg/web/fallos/fallos_mod2" data "a")
    (printout data "En la " ?parte "º parte del compás "?compas " la voz " ?voz1 " no resuelve. La séptima es una nota que provoca inestabilidad y tensión, por lo que se siente atraída por resolver en la tercera de la tónica de la tonalidad para eliminar esa tensión. Al no resolver esta inestabilidad se mantiene provocando una falta de coherencia en la línea melódica..")
    (close data)
)
...
(defrule mostrar_segunda_aumentada_melodica
    ...
    (open " ./tfg/web/fallos/fallos_mod2" data "a")
    (printout data "En la " ?parte "º parte del compás "?compas " en melodía de la voz " ?voz1 " hay una intervalo de segunda aumentada. El intervalo de segunda aumentada provoca una sonoridad extraña y tensión, sobre todo en modo mayor, por lo que debe ser evitada para cuidar la línea melódica.." )
    (close data)
)
...
(defrule mostrar_tritono_melodico
    ...
    (open " ./tfg/web/fallos/fallos_mod2" data "a")
    (printout data "En la " ?parte "º parte del compás "?compas " en la melodía de la voz " ?voz1 " hay una intervalo de tritono. El intervalo de cuarta aumentada o tritono es un intervalo disonante que crea mucha tensión, por lo cual es un intervalo prohibido dentro de este estilo de obras.." )
    (close data)
)
