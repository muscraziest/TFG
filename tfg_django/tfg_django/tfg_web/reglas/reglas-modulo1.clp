...
(defrule comprobar_sensibles_duplicadas
    ...
    (test (!= ?v1 ?v2))
    (not (exists (fallo (tipo duplicacion_sensible) (voz1 ?v2) (voz2 ?v1) (tiempo ?i))))
    =>
...
(defrule mostrar_quintas
    ...
    (printout data "En la " ?parte "º parte del compás "?compas " hay quintas paralelas en las voces " ?voz1 " y " ?voz2 ". Las quintas paralelas provocan una sonoridad dura y arcaica, lo cual está completamente fuera de estilo..") 
    (close data)
)
...
(defrule mostrar_octavas
    ...
    (open "./tfg_web/fallos/fallos_mod1" data "a") 
    (printout data "En la " ?parte "º parte del compás "?compas " hay octavas paralelas en las voces " ?voz1 " y " ?voz2 ". Las octavas paralelas generan pobreza armónica y sonoridad hueca..")
    (close data)
)
...
(defrule mostrar_quintas_directas
    ...
    (open "./tfg_web/fallos/fallos_mod1" data "a") 
    (printout data "En la " ?parte "º parte del compás "?compas " hay quintas directas en las voces " ?voz1 " y " ?voz2 ". Las quintas directas provocan que se pierda la independencia de las partes y un contrapunto pobre..")
    (close data)
)
...
(defrule mostrar_octavas_directas
    ...
    (open "./tfg_web/fallos/fallos_mod1" data "a") 
    (printout data "En la " ?parte "º parte del compás "?compas " hay octavas directas en las voces " ?voz1 " y " ?voz2 ". Las octavas directas provocan que se pierda la independencia de las partes y un contrapunto pobre..")
    (close data)
)
...
(defrule mostrar_tritono
    ...
    (open "./tfg_web/fallos/fallos_mod1" data "a") 
    (printout data "En la " ?parte "º parte del compás "?compas " hay un tritono entre las voces " ?voz1 " y " ?voz2 ". El intervalo de cuarta aumentada o tritono es un intervalo disonante que crea mucha tensión, por lo cual es un intervalo prohibido dentro de este estilo de obras..")
    (close data)
)
...
(defrule mostrar_duplicacion_sensibles
    ...
    (open "./tfg_web/fallos/fallos_mod1" data "a") 
    (printout data "En la " ?parte "º parte del compás "?compas " las voces " ?voz1 " y " ?voz2 " duplican la sensible de la tonalidad. La sensible es una nota que provoca inestabilidad y que se siente atraída por resolver en la tónica de la tonalidad. Al duplicar la sensible generaremos octavas paralelas, lo cual es una falta que no se puede dar en este estilo de obras..")
    (close data)
)
